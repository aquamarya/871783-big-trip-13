...
const createEditEventTemplate = (editEvent, id) => {
  const {type, description, startEventTime, endEventTime, price, eventTypes} = editEvent;
  //
  ...
  const createEventTypeList = (types) => {
    return types.fill().map((eventType) => {
      return (`
      <div class="event__type-item">
      ...
      <form class="event event--edit" action="#" method="post">
        <header class="event__header">
          <div class="event__type-wrapper">
            ...
            <div class="event__type-list">
              <fieldset class="event__type-group">
                ...
                ${createEventTypeList(eventTypes).join(` `)}
              </fieldset>
            </div>
          </div>
          <div class="event__field-group  event__field-group--destination">
            ...
            <input class="event__input  event__input--destination" id="event-destination-${id}" type="text" name="event-destination" value="${description}" list="destination-list-${id}">
          ...
          <div class="event__field-group  event__field-group--time">
            ...
            <input class="event__input  event__input--time" id="event-start-time-${id}" type="text" name="event-start-time" value="${dayjs(startEventTime).format(`YYYY/MM/DD HH:mm`)}">
            &mdash;
            <label class="visually-hidden" for="event-end-time-${id}">To</label>
            <input class="event__input  event__input--time" id="event-end-time-${id}" type="text" name="event-end-time" value="${dayjs(endEventTime).format(`YYYY/MM/DD HH:mm`)}">
          </div>
